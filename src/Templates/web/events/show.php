                ...
                <?php
                    ...
                    for ($member = 1; $member <= count($data)-1; $member++) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="member-edit-icon" href="<?= '/event/' . $data[0]['id'] . '/member/' . $data[$member]['id'] . '/edit' ?>">Edit</a>
                            </td>
                            <td>
                                <form action="<?= '/event/' . $data[0]['id'] . '/member/' . $data[$member]['id'] ?>" method="post">
                                    <input type="hidden" name="_method" value="delete">
                                    <input class="input-to-btn member-delete-btn member-delete-icon" type="submit" value="Delete">
                                </form>
                            </td>
                        </tr>
                    <?php } ?>
