<?php  //[STAMP] 77a168b84b9c217b9f357d6ffb2f15e7
...
trait IntegrationTesterActions
{
     ...
     *
     *
     * @see \Helper\Integration::createMapper()
     */
    public function createMapper($mapperName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createMapper', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Integration::insertEventEntity()
     */
    public function insertEventEntity() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('insertEventEntity', func_get_args()));
    }
